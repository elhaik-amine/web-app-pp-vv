...
const styles = StyleSheet.create({
  ...
  logoContainer: { width: 64, height: 64, backgroundColor: '#1A73E8', borderRadius: 16, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  logoIcon: { fontSize: 32 },
  appName: { fontSize: 28, fontWeight: '800', color: '#1A73E8', marginBottom: 8 },
  ...
  socialButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '48%', height: 56, borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, backgroundColor: '#FFFFFF' },
  socialButtonText: { marginLeft: 12, fontSize: 16, fontWeight: '600', color: '#191C23' },
  dividerContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: 32 },
  dividerLine: { flex: 1, height: 1, backgroundColor: '#E2E8F0' },
  dividerText: { paddingHorizontal: 16, fontSize: 12, fontWeight: '700', color: '#94A3B8', letterSpacing: 1 },
  form: { marginBottom: 40 },
  inputContainer: { marginBottom: 20 },
  label: { fontSize: 14, fontWeight: '700', color: '#191C23', marginBottom: 8 },
  input: { height: 56, borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, paddingHorizontal: 16, fontSize: 16, color: '#191C23', backgroundColor: '#F8FAFC' },
  passwordWrapper: { flexDirection: 'row', alignItems: 'center', height: 56, borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 12, paddingHorizontal: 16, backgroundColor: '#F8FAFC' },
  ...
  checkbox: { width: 20, height: 20, borderRadius: 4, borderWidth: 1, borderColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
